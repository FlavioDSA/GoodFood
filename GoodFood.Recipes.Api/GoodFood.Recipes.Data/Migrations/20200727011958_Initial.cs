...
namespace GoodFood.Recipes.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Amount = table.Column<string>(maxLength: 90, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_AppUserId_Slug",
                table: "Ingredients",
                columns: new[] { "AppUserId", "Slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipes_AppUserId_Slug",
                table: "Recipes",
                columns: new[] { "AppUserId", "Slug" },
                unique: true);
        }
